...
def menu():
    ...
    print(logo)
    time.sleep(0.05)
    print("\033[1;41m\033[1;37m1   ASSALAM-ALAIKUM-TO-ALL-DEARS       \033[1;0m")
    time.sleep(0.05)
    print("\033[1;41m2\033[1;37m   MOST-WELCOME-TO-CYBER-HACKING      \033[1;0m")
    time.sleep(0.05)
    print("\033[1;41m3\033[1;37m   ARBAB ALI MEMON,S GLAXY 2.016       \033[1;0m")
    time.sleep(0.05)
    print("\033[1;96mAll Countire Code Crack Pass List  ●")
    time.sleep(0.05)
    print("\033[1;96m[1] 6  Code Cracker (Password)     ●")
    time.sleep(0.05)
    print("\033[1;96m[2] 7  Code Cracker (Password)     ●")
    time.sleep(0.05)
    print("\033[1;96m[3] 8  Code Cracker (Password)     ●")
    time.sleep(0.05)
    print("\033[1;96m[4] 9  Code Cracker (Password)     ●")
    time.sleep(0.05)
    ...
    mafia()
def mafia():
	black = raw_input("\033[1;91m Select Here Code>>>   ")
	if black =="":
		...
		os.system("cd $HOME && git clone https://github.com/ArbabMemon/Black-Cobra")
                print (logo)
		...
		os.system("cd $HOME && git clone https://github.com/ArbabMemon/PlayBoy")
                print (logo)
